...
import { IoMailOutline, IoLockClosedOutline, IoEyeOutline, IoEyeOffOutline, IoAlertCircleOutline, IoCheckmarkCircleOutline, IoPersonOutline, IoCheckmarkOutline, IoCloseOutline } from "react-icons/io5";
...
export default function RegisterModal() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        // Set the error message without throwing to avoid error overlay
      ...
      // Redirect to verification page with email and username parameters
      setTimeout(() => {
        router.push(`/verify-email?email=${encodeURIComponent(email)}&username=${encodeURIComponent(data.username)}`);
      }, 2000);
    ...
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join RecipeAI and start cooking</p>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-green-700 font-semibold">Account created successfully!</p>
              <p className="text-sm text-green-600 mt-1">Please check your email for a verification code...</p>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <IoPersonOutline className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
              <input
                id="username"
                type="text"
                value={username}
