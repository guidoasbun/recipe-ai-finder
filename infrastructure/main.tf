...
resource "aws_ecs_task_definition" "main" {
  ...
  # Specify ARM64 architecture for AWS Graviton (cheaper and compatible with Apple Silicon)
  runtime_platform {
  ...
  container_definitions = jsonencode([{
    ...
    secrets = [
      ...
      },
      {
        ...
        valueFrom = aws_ssm_parameter.app_aws_secret_access_key.arn
      },
      {
        name      = "AWS_REGION"
      ...
      },
      {
        ...
        valueFrom = aws_ssm_parameter.dynamo_table_name.arn
      },
      {
        name      = "S3_BUCKET_NAME"
